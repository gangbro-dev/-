...
def get_rot():
    ...
    rot_data = [rot_data[0]/rot_const, rot_data[1]/rot_const, rot_data[2]/rot_const]
    return rot_data
...
class ModalOperator(bpy.types.Operator):
    ...
    def execute(self, context):
        context.object.rotation_euler[0] = self.value_x 
        context.object.rotation_euler[1] = self.value_y
        context.object.rotation_euler[2] = self.value_z
...
#                current[i] = current_v[i] + (current[i] *dt)
        current = get_rot()
        ...
        if event.type == 'LEFTMOUSE':
            ...
            context.object.rotation_euler[0] = self.init_rot_x
            context.object.rotation_euler[1] = self.init_rot_y
            context.object.rotation_euler[2] = self.init_rot_z
            return {'CANCELLED'}
    ...
    def invoke(self, context, event):
        ...
        self.init_rot_x = context.object.rotation_euler[0]
        self.init_rot_y = context.object.rotation_euler[1]
        self.init_rot_z = context.object.rotation_euler[2]
        self.value_x = 0
        self.value_y = 0
        self.value_z = 0
        self.execute(context)
